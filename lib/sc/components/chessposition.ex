defmodule Genomeur.Component.ChessPosition do
  ...
  def validate(data) do
    {
      :error,
      """
      #{IO.ANSI.red()} Invalid PonchoScenic.Component.ChessPosition spec componenet
  ...
  def handle_event({:click, :settings}, _, scene) do
    IO.puts("Clicked Settings__________-")
    {:noreply, scene}
  end

  def handle_event({:click, :send_it}, _, scene) do
    IO.puts("Clicked Send IT !!!")
    {:noreply, scene}
  end
end
